            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className='mt-8'>
                    ...
                    <div className="w-full max-w-2xl min-w-[200px]">
                        <input disabled value={`https://digitize.gp.lib.mi.us/history/newspapers/gpreview/${fileURL}.pdf`} className="w-full bg-slate-200 pointer-events-none placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow" placeholder="Type here..." />
                    </div>
                </div>
